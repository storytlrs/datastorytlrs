...
export const AdsDataTab = ({ reportId, spaceId, onImportSuccess, embedded = false }: AdsDataTabProps) => {
  ...
  const allCampaignColumns: ColumnDef[] = [
    ...
    { key: "publisher_platform", label: "Publisher", type: "text", width: "110px", editable: false },
    { key: "age", label: "Age", type: "text", width: "90px", editable: false },
    { key: "gender", label: "Gender", type: "text", width: "90px", editable: false },
