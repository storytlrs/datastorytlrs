        ...
        >
          {METRIC_OPTIONS.map((option) => (
            <ToggleGroupItem 
              key={option.value} 
              value={option.value}
              className="rounded-[35px] border border-foreground px-4 py-2 data-[state=on]:bg-accent-green data-[state=on]:text-foreground data-[state=on]:border-accent-green"
            >
              {option.label}
            </ToggleGroupItem>
          ))}
