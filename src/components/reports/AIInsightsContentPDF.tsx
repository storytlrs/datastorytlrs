 ...
 * - Fixed A4 landscape page wrappers
 * - Compact typography and spacing
 * - No interactive elements (edit buttons, dialogs)
 * - Stable 2-column layouts
 */
export const AIInsightsContentPDF = forwardRef<HTMLDivElement, AIInsightsContentPDFProps>(({
  ...
  return (
    <div ref={ref}>
      ...
      <div className="pdf-page pdf-mode">
        <Card className="p-4 rounded-[20px] border-foreground h-full" style={{ backgroundColor: '#E9E9E9' }}>
      ...
      {/* Pages 7+: Creator Performance - one per page */}
      {insights.creator_performance && insights.creator_performance.length > 0 ? (
        insights.creator_performance.map((creator) => {
          ...
          return (
            <div key={creator.handle} className="pdf-page pdf-mode">
              <Card className="p-4 rounded-[20px] border-foreground h-full" style={{ backgroundColor: '#E9E9E9' }}>
