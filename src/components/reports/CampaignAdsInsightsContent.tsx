        ...
        <Card className="p-6 rounded-[20px] border-foreground" style={{ backgroundColor: "#E9E9E9" }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card className="p-4 rounded-[15px] border-border bg-muted/30">
              ...
              <EditableListSection items={topResult} isEditing={editingSections.has("top_result")} onStartEdit={() => startEditing("top_result")} onSave={(items) => handleSaveListSection("top_result", items)} onCancel={() => stopEditing("top_result")} canEdit={canEdit} bulletColor="text-accent-green" placeholder="Nejlepší výsledek kampaně..." />
            </Card>
            <Card className="p-4 rounded-[15px] border-border bg-muted/30">
              ...
              <EditableListSection items={recommendation} isEditing={editingSections.has("recommendation")} onStartEdit={() => startEditing("recommendation")} onSave={(items) => handleSaveListSection("recommendation", items)} onCancel={() => stopEditing("recommendation")} canEdit={canEdit} bulletColor="text-accent-orange" placeholder="Doporučení pro příští kampaň..." />
            </Card>
          </div>
        </Card>
