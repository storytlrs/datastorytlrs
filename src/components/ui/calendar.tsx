  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-accent-green text-accent-green-foreground hover:bg-accent-green hover:text-accent-green-foreground focus:bg-accent-green focus:text-accent-green-foreground",
        day_today: "bg-primary/10 text-foreground",
        day_outside:
